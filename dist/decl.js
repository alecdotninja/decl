...
var Scope = (function () {
    ...
    Scope.prototype.drawTreeLines = function () {
        var lines = [];
        var self = this.name + '(' + this.subscriptions.length + ' subscriptions)';
